...
function trigger() {
    ...
    for (let t = 0; t < i.length; t += 1) {
        ...
        for (let t = 0; t < this.length; t += 1) {
            const i = this[t];
            if (e.CustomEvent) {
                const t = new e.CustomEvent(a, {detail: r, bubbles: !0, cancelable: !0});
...
function offset() {
    if (this.length > 0) {
        const e = getWindow(), t = getDocument(), s = this[0], a = s.getBoundingClientRect(), i = t.body,
...
function append() {
    ...
    for (let s = 0; s < arguments.length; s += 1) {
        ...
        } else if (e instanceof Dom7) for (let t = 0; t < e.length; t += 1) this[s].appendChild(e[t]); else this[s].appendChild(e)
    }
    return this
}
...
function Observer(e) {
    ...
    const r = [], n = getWindow(), l = function (e, t) {
        void 0 === t && (t = {});
...
function loopCreate() {
    const e = this, t = getDocument(), {params: s, $wrapperEl: a} = e,
...
function onTouchStart(e) {
    ...
    const u = n.currentX, h = n.currentY, m = r.edgeSwipeDetection || r.iOSEdgeSwipeDetection,
...
const events = (e, t) => {
    const s = getDocument(), {params: a, touchEvents: i, el: r, wrapperEl: n, device: l, support: o} = e,
        d = !!a.nested, c = "on" === t ? "addEventListener" : "removeEventListener", p = t;
    if (o.touch) {
...
function setBreakpoint() {
    ...
    const o = (l in n ? n[l] : void 0) || e.originalParams, d = isGridEnabled(e, i), c = isGridEnabled(e, o),
        p = i.enabled;
...
function Virtual(e) {
    ...
    function l(e) {
        ...
        for (let t = 0; t < p.length; t += 1) t >= w && t <= b && (void 0 === c || e ? $.push(t) : (t > c && $.push(t), t < d && E.push(t)));
        $.forEach((e => {
    ...
    function l(e) {
        ...
        if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || r.activeElement && r.activeElement.nodeName && ("input" === r.activeElement.nodeName.toLowerCase() || "textarea" === r.activeElement.nodeName.toLowerCase()))) {
            if (t.params.keyboard.onlyInViewport && (d || c || p || u || h || m)) {
                ...
                const a = t.$el, i = a[0].clientWidth, r = a[0].clientHeight, l = n.innerWidth, o = n.innerHeight,
                    d = t.$el.offset();
...
function Mousewheel(e) {
    ...
    function h(e) {
        ...
        let c = 0;
        const p = t.rtlTranslate ? -1 : 1, h = function (e) {
            let t = 0, s = 0, a = 0, i = 0;
        ...
        if (m >= t.minTranslate() && (m = t.minTranslate()), m <= t.maxTranslate() && (m = t.maxTranslate()), a = !!t.params.loop || !(m === t.minTranslate() || m === t.maxTranslate()), a && t.params.nested && s.stopPropagation(), t.params.freeMode && t.params.freeMode.enabled) {
            ...
            const s = {time: now(), delta: Math.abs(c), direction: Math.sign(c), raw: e};
            d.length >= 2 && d.shift();
        ...
        if (t.params.loop ? (c = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup), c > a - 1 - 2 * t.loopedSlides && (c -= a - 2 * t.loopedSlides), c > p - 1 && (c -= p), c < 0 && "bullets" !== t.params.paginationType && (c = p + c)) : c = void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0, "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
            ...
            if (s.dynamicBullets && (n = a.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0), r.css(t.isHorizontal() ? "width" : "height", n * (s.dynamicMainBullets + 4) + "px"), s.dynamicMainBullets > 1 && void 0 !== t.previousIndex && (l += c - (t.previousIndex - t.loopedSlides || 0), l > s.dynamicMainBullets - 1 ? l = s.dynamicMainBullets - 1 : l < 0 && (l = 0)), i = Math.max(c - l, 0), o = i + (Math.min(a.length, s.dynamicMainBullets) - 1), p = (o + i) / 2), a.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map((e => `${s.bulletActiveClass}${e}`)).join(" ")), r.length > 1) a.each((e => {
                ...
                if (e.addClass(s.bulletActiveClass), s.dynamicBullets) {
                    ...
                    } else d(e, "prev"), d(n, "next"); else d(e, "prev"), d(n, "next")
                }
            }
            if (s.dynamicBullets) {
...
function Scrollbar(e) {
    ...
    function x(e) {
        const {scrollbar: s, touchEventsTouch: a, touchEventsDesktop: i, params: n, support: l} = t, o = s.$el[0],
            d = !(!l.passiveListener || !n.passiveListeners) && {passive: !1, capture: !1},
            c = !(!l.passiveListener || !n.passiveListeners) && {passive: !0, capture: !1};
        if (!o) return;
        const p = "on" === e ? "addEventListener" : "removeEventListener";
        l.touch ? (o[p](a.start, v, d), o[p](a.move, w, d), o[p](a.end, b, c)) : (o[p](i.start, v, d), r[p](i.move, w, d), r[p](i.end, b, c))
    }
    ...
    function y() {
        ...
        0 === r.length && (r = $(`<div class="${t.params.scrollbar.dragClass}"></div>`), i.append(r)), Object.assign(e, {
            ...
            $dragEl: r,
            dragEl: r[0]
        }), a.draggable && t.params.scrollbar.el && x("on"), i && i[t.enabled ? "removeClass" : "addClass"](t.params.scrollbar.lockClass)
    }
    ...
    s({
    ...
    }), t.scrollbar = {el: null, dragEl: null, $el: null, $dragEl: null}, a("init", (() => {
        y(), m(), h()
        ...
        E()
    })), Object.assign(t.scrollbar, {updateSize: m, setTranslate: h, init: y, destroy: E})
}
...
function Parallax(e) {
    ...
    const i = (e, s) => {
        const {rtl: a} = t, i = $(e), r = a ? -1 : 1, n = i.attr("data-swiper-parallax") || "0";
...
function Zoom(e) {
    ...
    function z() {
        ...
        if (e.enabled) return;
        e.enabled = !0;
        const s = t.support, {passiveListener: a, activeListenerWithCapture: i} = S(), r = C();
    ...
    function O() {
        ...
        const s = t.support;
        e.enabled = !1;
        const {passiveListener: a, activeListenerWithCapture: i} = S(), r = C();
    ...
    Object.defineProperty(t.zoom, "scale", {
        ...
        t.zoom.enabled && function () {
            ...
            let s = 300, a = 300;
            const i = h.x * s, r = u.currentX + i, n = h.y * a, l = u.currentY + n;
...
function Lazy(e) {
    ...
    function l(e, s) {
        ...
        !r.hasClass(a.elementClass) || r.hasClass(a.loadedClass) || r.hasClass(a.loadingClass) || n.push(r[0]), 0 !== n.length && n.each((e => {
            ...
            const o = n.attr("data-background"), d = n.attr("data-src"), c = n.attr("data-srcset"),
    ...
    function o() {
        const {$wrapperEl: e, params: s, slides: a, activeIndex: i} = t, r = t.virtual && s.virtual.enabled, o = s.lazy;
        ...
        })); else if (d > 1) for (let e = i; e < i + d; e += 1) c(e) && l(e); else l(i);
        if (o.loadPrevNext) if (d > 1 || o.loadPrevNextAmount && o.loadPrevNextAmount > 1) {
            const e = o.loadPrevNextAmount, t = d, s = Math.min(i + t + Math.max(e, t), a.length),
    ...
    function d() {
        ...
        const s = t.params.lazy.scrollingElement ? $(t.params.lazy.scrollingElement) : $(e), a = s[0] === e,
            i = a ? e.innerWidth : s[0].offsetWidth, n = a ? e.innerHeight : s[0].offsetHeight,
            l = t.$el.offset(), {rtlTranslate: c} = t;
        let p = !1;
        c && (l.left -= t.$el[0].scrollLeft);
        const u = [[l.left, l.top], [l.left + t.width, l.top], [l.left, l.top + t.height], [l.left + t.width, l.top + t.height]];
...
function A11y(e) {
    ...
    function w() {
        ...
        var p;
        p = r, a.attr("id", p), function (e, t) {
            e.attr("aria-live", t)
        }(a, l), e.itemRoleDescriptionMessage && d($(t.slides), e.itemRoleDescriptionMessage), o($(t.slides), e.slideRole);
        const u = t.params.loop ? t.slides.filter((e => !e.classList.contains(t.params.slideDuplicateClass))).length : t.slides.length;
        let m, w;
        t.slides.each(((s, a) => {
            const i = $(s), r = t.params.loop ? parseInt(i.attr("data-swiper-slide-index"), 10) : a;
            c(i, e.slideLabelMessage.replace(/\{\{index\}\}/, r + 1).replace(/\{\{slidesLength\}\}/, u))
        })), t.navigation && t.navigation.$nextEl && (m = t.navigation.$nextEl), t.navigation && t.navigation.$prevEl && (w = t.navigation.$prevEl), m && m.length && g(m, r, e.nextSlideMessage), w && w.length && g(w, r, e.prevSlideMessage), f() && t.pagination.$el.on("keydown", classesToSelector(t.params.pagination.bulletClass), h), t.$el.on("focus", v, !0)
    }
...
function HashNavigation(e) {
    ...
    const o = () => {
        ...
        if (r && t.params.hashNavigation.enabled) if (t.params.hashNavigation.replaceState && l.history && l.history.replaceState) l.history.replaceState(null, null, `#${t.slides.eq(t.activeIndex).attr("data-hash")}` || ""), a("hashSet"); else {
...
function Autoplay(e) {
    ...
    s.autoplay = {running: !1, paused: !1}, a({
        autoplay: {
            enabled: !1,
            delay: 3e3,
            waitForTransition: !0,
    ...
    effectInit({
        ...
        setTranslate: () => {
            ...
            for (let a = 0; a < e.length; a += 1) {
                ...
                effectTarget(s, e).css({opacity: n}).transform(`translate3d(${i}px, ${r}px, 0px)`)
            }
        },
        setTransition: e => {
...
function EffectCube(e) {
    ...
    effectInit({
        ...
        setTranslate: () => {
            ...
            let h, m = 0;
            c.shadow && (p ? (h = s.find(".swiper-cube-shadow"), 0 === h.length && (h = $('<div class="swiper-cube-shadow"></div>'), s.append(h)), h.css({height: `${r}px`})) : (h = e.find(".swiper-cube-shadow"), 0 === h.length && (h = $('<div class="swiper-cube-shadow"></div>'), e.append(h))));
            for (let e = 0; e < a.length; e += 1) {
                const t = a.eq(e);
                let s = e;
            ...
            }), c.shadow) if (p) h.transform(`translate3d(0px, ${r / 2 + c.shadowOffset}px, ${-r / 2}px) rotateX(90deg) rotateZ(0deg) scale(${c.shadowScale})`); else {
